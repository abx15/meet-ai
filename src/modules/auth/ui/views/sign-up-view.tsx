  ...
  const onSubmit = async (data: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      if (response.error) {
        ...
        // Registration successful, redirect to sign-in or wait for email verification
        setError(null);
        // For now, redirect to sign-in page to let user login
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4 sm:p-6 lg:p-8">
      ...
      <div className="text-center text-xs sm:text-sm text-slate-600 mt-6 lg:mt-8 px-4 max-w-md mx-auto">
        ...
        <Link
          href="/privacy"
          className="text-slate-900 hover:text-slate-700 font-semibold underline-offset-4 hover:underline break-words"
        >
          Privacy Policy
        </Link>{" "}
        and{" "}
